...
public class SwerveModule {
    ...
    public void setDesiredState(SwerveModuleState state) {
        ...
        // SmartDashboard.putString("CANcoder[" + absoluteEncoder.getDeviceID() + "] +
        // angle ", String.valueOf(absoluteEncoder.getPosition()) + " "
        // +String.valueOf((absoluteEncoder.getPosition().getValueAsDouble()*360)%360)
        // );
    ...
    public void wheelZero() {
        ...
        // turningMotor.set(turningPidController.calculate(absoluteEncoder.getPosition().getValueAsDouble()
        // * 21.428,0));
    }
